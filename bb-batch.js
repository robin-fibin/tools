...
return out;}
function waitAndGo(lenBefore,timedOutCb,doneCb){
var tries=0;
var t=setInterval(function(){
tries++;
if(hdn.value.length!==lenBefore){clearInterval(t);setTimeout(function(){doneCb(document.querySelectorAll('tr.DataRow').length>0);},400);}
else if(tries>30){clearInterval(t);timedOutCb();}
},500);}
